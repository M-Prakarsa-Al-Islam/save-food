...
import { ChevronLeft, MapPin, Clock, Box, Sparkles, Tag, ClipboardList, Star, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="bg-slate-100 dark:bg-slate-900 min-h-screen">
      ...
      <div className="bg-slate-100 dark:bg-slate-900 rounded-t-2xl -mt-4 p-4 space-y-6 pb-24">
        ...
        <div className="grid grid-cols-2 gap-4 text-center bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm dark:border dark:border-slate-700">
            ...
            <div className="flex flex-col items-center">
                ...
                <CountdownTimer expiresAt={foodItem.expiresAt} onExpire={() => { /* maybe refresh data */ }} />
                <span className="text-sm text-gray-500 dark:text-gray-400">{t('timeLeft')}</span>
            </div>
        </div>
